...
export default function Contact() {
    return (
        <div className="Contato px-4 sm:px-6 py-6 sm:py-8">
            <p className="text-lg mb-4 text-[#808080]"> (05) <br/> Contate-nos</p>
                ...
                <div className="flex flex-col space-y-2 sm:space-y-4 font-sans mb-6 sm:mb-0">
                    <div>
                        <h2 className="text-3xl sm:text-5xl text-gray-400">
                            Vamos <span className="text-white font-semibold">discutir</span> seu
                        </h2>
                    </div>
                    <div className="text-3xl sm:text-5xl text-gray-400 flex flex-wrap items-center">
                        projeto
                        <span className="ml-0 sm:ml-4 mt-2 sm:mt-0 text-xl sm:text-2xl font-mono text-black bg-white rounded-full px-3 sm:px-5 py-2 sm:py-3">VAMOS CONVERSAR</span>
                        ...
                        <span className="ml-2 sm:ml-4 text-white font-semibold">com a gente</span>
                    </div>
                </div>
                <div className="text-left sm:text-right space-y-0 text-sm mt-4 sm:mt-6">
                    <p>Avenida das Acácias, 456,</p>
                    <p>São Paulo, SP</p>
                    <p>Brasil</p>
                    <p>31 99233-2343</p>
                    <p>creacy@contato.com</p>
                </div>
            </div>
        </div>
    );
